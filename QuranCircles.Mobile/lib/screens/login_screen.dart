                ...
                Wrap(
                  ...
                  children: [
                    ...
                    ActionChip(
                      ...
                      label: const Text('المعلم (أحمد)'),
                      onPressed: () => _quickFill('ahmad', 'teacher123'),
                    ),
                    ActionChip(
                      avatar: const Icon(Icons.person, size: 16, color: AppTheme.primary),
                      label: const Text('الطالب (محمد)'),
                      onPressed: () => _quickFill('std_1', 'student123'),
                    ),
                    ActionChip(
                      avatar: const Icon(Icons.family_restroom, size: 16, color: AppTheme.primary),
                      label: const Text('ولي الأمر'),
                      onPressed: () => _quickFill('parent_std_1', 'parent123'),
                    ),
                  ],
                ),
                const SizedBox(height: 20),
